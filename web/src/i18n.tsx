...
const dict: Record<string, Loc> = {
  ...
  eval_generating: { en: 'Generating…', ar: 'جارٍ الإنشاء…' },
  eval_pick_employee_h: { en: 'Pick an employee to get started', ar: 'اختر موظفًا للبدء' },
  eval_pick_employee_p: {
    en: 'Choose an employee above to see their evaluation history, or generate a new one for a date range.',
    ar: 'اختر موظفًا أعلاه لعرض سجل تقييماته، أو أنشئ تقييمًا جديدًا لفترة زمنية محددة.',
  },
  eval_none_h: { en: 'No evaluations yet', ar: 'لا توجد تقييمات بعد' },
  eval_none_p: { en: 'Pick a period above and generate the first one.', ar: 'اختر فترة أعلاه وأنشئ أول تقييم.' },
  eval_load_err: { en: 'Couldn’t load evaluations:', ar: 'تعذّر تحميل التقييمات:' },
  eval_loading: { en: 'Loading evaluations…', ar: 'جارٍ تحميل التقييمات…' },
  col_period: { en: 'Period', ar: 'الفترة' },
  col_score: { en: 'Score', ar: 'النتيجة' },
  col_generated_by: { en: 'Generated by', ar: 'أنشأه' },
  col_generated_at: { en: 'Generated at', ar: 'تاريخ الإنشاء' },
  eval_view_breakdown: { en: 'View breakdown', ar: 'عرض التفاصيل' },
  eval_hide_breakdown: { en: 'Hide breakdown', ar: 'إخفاء التفاصيل' },
  ...
  eval_metric_completed: { en: 'Completed requests', ar: 'الطلبات المكتملة' },
  eval_metric_open: { en: 'Current open workload', ar: 'عبء العمل المفتوح حاليًا' },
  eval_no_data: { en: 'No data in this period', ar: 'لا توجد بيانات لهذه الفترة' },
  ...
  dept_none_p: {
    en: 'Create your first department — name and branch are all you need. Add a head and employees now or later.',
    ar: 'أنشئ أول دائرة — الاسم والفرع فقط كافيان. أضف رئيسًا وموظفين الآن أو لاحقًا.',
  },
  ...
  dept_members_label: {
    en: 'Employees (optional — check to include, pick one as head)',
    ar: 'الموظفون (اختياري — فعّل للإدراج، واختر واحدًا كرئيس)',
  },
  dept_members_hint: {
    en: 'You can skip this and add a head or employees later from Employees or a CSV import.',
    ar: 'يمكنك تخطي هذا وإضافة رئيس أو موظفين لاحقًا من صفحة الموظفين أو عبر استيراد CSV.',
  },
  ...
  rep_generated_by: { en: 'Generated by', ar: 'أنشأه' },
  rep_print_preparing: { en: 'Preparing…', ar: 'جارٍ التحضير…' },
  rep_print_showing: {
    en: 'Showing the first 100 of {total} matching requests.',
    ar: 'عرض أول 100 من أصل {total} طلبًا مطابقًا.',
  },
  ...
  sc_clear_week: { en: 'Clear week', ar: 'إفراغ الأسبوع' },
  sc_clearing: { en: 'Clearing…', ar: 'جارٍ الإفراغ…' },
  sc_clear_week_q: { en: 'Clear every shift this week?', ar: 'إفراغ جميع الورديات هذا الأسبوع؟' },
  sc_clear_week_warn: { en: 'This removes every shift currently assigned in this displayed week. It cannot be undone.', ar: 'سيؤدي هذا إلى إزالة كل وردية معيّنة حاليًا في هذا الأسبوع المعروض. لا يمكن التراجع عن هذا الإجراء.' },
  ...
  cl_new_err_required: { en: 'Name (both languages) and department are required.', ar: 'الاسم (باللغتين) والقسم مطلوبان.' },
  ...
  kb_read: { en: 'Read', ar: 'قراءة' },
  kb_search: { en: 'Search articles…', ar: 'ابحث في المقالات…' },
  kb_no_match_h: { en: 'No articles match this search', ar: 'لا توجد مقالات مطابقة لهذا البحث' },
  ...
  ev_none_upcoming_h: { en: 'No upcoming events', ar: 'لا توجد فعاليات قادمة' },
  ev_no_attendees: { en: 'Nobody has joined yet.', ar: 'لم ينضم أحد بعد.' },
  ...
  ob_err_pick_feature: { en: 'Pick at least one feature.', ar: 'اختر ميزة واحدة على الأقل.' },
  ob_err_logo_type: { en: 'The logo must be a PNG or JPEG image.', ar: 'يجب أن يكون الشعار صورة PNG أو JPEG.' },
  ob_err_already_done: {
    en: 'Setup was already completed — reload the page to continue.',
    ar: 'تم إكمال الإعداد بالفعل — أعد تحميل الصفحة للمتابعة.',
  },
  ob_review_title: { en: 'Review', ar: 'المراجعة' },
  ob_review_hint: {
    en: 'Check everything before finishing.',
    ar: 'راجع كل شيء قبل الإنهاء.',
  },
  ob_review_editable: {
    en: 'You can change any of this later under Settings.',
    ar: 'يمكنك تغيير أي من هذا لاحقًا من الإعدادات.',
  },
  ob_review_section_plan: { en: 'Plan & features', ar: 'الخطة والميزات' },
  ob_review_branch_label: { en: 'Branch', ar: 'الفرع' },
  nav_settings: { en: 'Settings', ar: 'الإعدادات' },
  set_title: { en: 'Company settings', ar: 'إعدادات الشركة' },
  set_saved: { en: 'Settings saved.', ar: 'تم حفظ الإعدادات.' },
  set_save: { en: 'Save settings', ar: 'حفظ الإعدادات' },
  set_sec_company: { en: 'Company', ar: 'الشركة' },
  set_sec_profile: { en: 'Industry & size', ar: 'القطاع والحجم' },
  set_sec_branding: { en: 'Branding & logins', ar: 'الهوية وتسجيل الدخول' },
  set_branches_h: { en: 'Branches', ar: 'الفروع' },
  set_add_branch: { en: 'Add branch', ar: 'إضافة فرع' },
  set_branch_in_use: { en: 'In use by a department', ar: 'مستخدم من قِبل قسم' },
  set_features_h: { en: 'Feature modules', ar: 'وحدات الميزات' },
  set_features_hint: {
    en: 'Turning a module off hides it for everyone, including you. Its data is kept and comes back if you turn it on again.',
    ar: 'إيقاف وحدة يخفيها عن الجميع، بما فيهم أنت. تُحفظ بياناتها وتعود عند إعادة تفعيلها.',
  },
  set_logo_replace: { en: 'Replace logo', ar: 'استبدال الشعار' },
  ...
  svc_auto_assign_hint: {
    en: 'Automatically picks the least-busy active employee in the service’s department the moment a request comes in — the first step below is set up for this automatically. You can always reassign manually afterward.',
    ar: 'يختار تلقائيًا الموظف النشط الأقل انشغالًا في قسم الخدمة لحظة وصول طلب جديد — يتم إعداد المرحلة الأولى أدناه لهذا تلقائيًا. يمكنك دائمًا إعادة الإسناد يدويًا لاحقًا.',
  },
  ...
  svc_review_who_h: { en: 'Who moves it forward', ar: 'من ينقل الطلب' },
  svc_review_step: { en: 'Step', ar: 'المرحلة' },
  svc_review_who: { en: 'Who', ar: 'من' },
  svc_review_needs: { en: 'Requires', ar: 'يتطلّب' },
  svc_who_assignee: { en: 'The assigned employee', ar: 'الموظف المُكلَّف' },
  svc_who_assign: { en: 'Oversight — assigns the employee', ar: 'إشرافي — يُسند الموظف' },
  svc_who_oversight: { en: 'Any oversight employee', ar: 'أي موظف إشرافي' },
  svc_needs_completion: { en: 'Completion form', ar: 'نموذج الإنجاز' },
  svc_edit_title: { en: 'Edit service', ar: 'تعديل الخدمة' },
  svc_edit_saved_h: { en: 'Service updated', ar: 'تم تحديث الخدمة' },
  svc_edit_frozen: {
    en: 'This service already has requests, so its definition is frozen. Disable it and create a new one instead.',
    ar: 'هذه الخدمة لديها طلبات بالفعل، لذا تم تجميد تعريفها. عطّلها وأنشئ خدمة جديدة بدلًا من ذلك.',
  },
  svc_edit_unsupported: {
    en: 'This service was not built with this wizard, so it can’t be reopened here. Disable it and create a new one instead.',
    ar: 'لم يتم إنشاء هذه الخدمة بواسطة هذا المعالج، لذا لا يمكن فتحها هنا. عطّلها وأنشئ خدمة جديدة بدلًا من ذلك.',
  },
  svc_save_changes: { en: 'Save changes', ar: 'حفظ التغييرات' },
  svc_list_title: { en: 'Services', ar: 'الخدمات' },
  svc_list_none_h: { en: 'No services yet', ar: 'لا توجد خدمات بعد' },
  svc_list_none_p: { en: 'Create your first service to start taking requests.', ar: 'أنشئ خدمتك الأولى لبدء استقبال الطلبات.' },
  svc_col_enabled: { en: 'Enabled', ar: 'مُفعّلة' },
  svc_col_auto_assign: { en: 'Auto-assign', ar: 'إسناد تلقائي' },
  svc_edit_locked: { en: 'Has requests — definition frozen', ar: 'لديها طلبات — التعريف مجمّد' },
  svc_new: { en: 'New service', ar: 'خدمة جديدة' },
